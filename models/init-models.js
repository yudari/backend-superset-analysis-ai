...
export default function initModels(sequelize) {
  ...
  dashboard_slices.hasOne(tb_tab_dashboard_embed, { as: "tb_tab_dashboard_embed", foreignKey: "id_tab_dashboard_chart" });
  ...
  tb_chart_result_analysis.belongsTo(tb_tab_dashboard_embed, { as: "id_tab_dashboard_chart_tb_tab_dashboard_embed", foreignKey: "id_tab_dashboard_chart" });
  tb_tab_dashboard_embed.hasOne(tb_chart_result_analysis, { as: "tb_chart_result_analysis", foreignKey: "id_tab_dashboard_chart" });
  tb_tab_dashboard_result_analysis.belongsTo(tb_tab_dashboard_embed, { as: "id_tab_dashboard_chart_tb_tab_dashboard_embed", foreignKey: "id_tab_dashboard_chart" });
  tb_tab_dashboard_embed.hasOne(tb_tab_dashboard_result_analysis, { as: "tb_tab_dashboard_result_analysis", foreignKey: "id_tab_dashboard_chart" });
