...
export default function initModels(sequelize) {
  ...
  tb_chart_result_analysis.belongsTo(tb_tab_dashboard_embed, { as: "id_tab_chart_tb_tab_dashboard_embed", foreignKey: "id_tab_chart"});
  tb_tab_dashboard_embed.hasMany(tb_chart_result_analysis, { as: "tb_chart_result_analyses", foreignKey: "id_tab_chart"});
